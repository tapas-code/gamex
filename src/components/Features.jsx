    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 me-14 md:me-0 ">
            <BentoCard
              src="videos/feature-4.mp4"
              title={
                <>
                  Az<b className="special-font">u</b>l
                </>
              }
          ...
          <BentoTilt className="bento-tilt_2">
              <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                <h1 className="bento-title max-w-64 text-black">M<b className="special-font">o</b>re comi<b className="special-font">n</b>g s<b className="special-font">o</b>on!</h1>
